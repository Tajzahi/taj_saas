...
const TenantBrandingSchema = z.object({
  ...
  logoUrl: z.string().max(2000000).optional(),
  logo: z.string().max(2000000).optional(),
  faviconUrl: z.string().max(2000000).optional(),
  ...
  heroBannerUrl: z.string().max(2000000).optional(),
  storeOpen: z.boolean().optional(),
  qrisImageUrl: z.string().max(2000000).optional(),
